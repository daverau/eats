...
class Login extends Controller {
    ...
    function index() {
		...
		header('location: ' . URL);
		// added redirect to simplify views
    ...
    function verifypasswordrequest($user_email, $verification_code) {
        
        if ($this->model->verifypasswordrequest($user_email, $verification_code)) {
            
            $this->view->user_email = $this->model->user_email;
