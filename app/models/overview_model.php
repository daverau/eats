...
class Overview_Model extends Model {
    ...
    public function getAllUsersProfiles() {
        ...
        $sth = $this->db->prepare("SELECT user_id, user_email, user_email, user_active, user_has_avatar FROM users");
        $sth->execute();
    ...
    public function getUserProfile($user_id) {
        ...
        $sth = $this->db->prepare("SELECT user_id, user_email, user_active, user_has_avatar FROM users WHERE user_id = :user_id");
