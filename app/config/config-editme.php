 ...
 */
define('URL', 'http://eats.local/app/');
 ...
 */
define('COOKIE_RUNTIME', 2409600); // 1209600 seconds = 2 weeks
define('COOKIE_DOMAIN', '.eats.local'); // the domain where the cookie is valid for
...
define("EMAIL_SMTP_USERNAME", 'eatsapp@gmail.com');
...
define("EMAIL_PASSWORDRESET_FROM_EMAIL", "noreply@eats.local");
define("EMAIL_PASSWORDRESET_FROM_NAME", "eats.local");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset");
define("EMAIL_PASSWORDRESET_CONTENT", "Click to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "noreply@eats.local");
define("EMAIL_VERIFICATION_FROM_NAME", "eats.local");
define("EMAIL_VERIFICATION_SUBJECT", "Activate Your eats.local Account");
define("EMAIL_VERIFICATION_CONTENT", "Click to activate your account: ");
